//#region node_modules/tailwindcss/dist/chunk-DCG7AFIE.mjs
var o = {
	inherit: "inherit",
...
//#endregion
//#region node_modules/tailwindcss/dist/chunk-C2OYBFIH.mjs
...
function ge$1(e, t) {
	...
	for (let r of t) if (P$1[r]?.(e)) return r;
	return null;
}
var z = /^url\(.*\)$/;
function R(e) {
...
//#endregion
//#region node_modules/tailwindcss/dist/chunk-5JIJA4QV.mjs
function h(n) {
...
var p = class {
	...
	getOptions(e) {
		return e = a$1(this.#i(e)), this.values.get(e)?.options ?? 0;
	}
	entries() {
...
//#endregion
//#region node_modules/tailwindcss/dist/lib.mjs
var yr = "4.3.3";
function mn(e) {
	return {
		kind: "combinator",
	...
	for (let p = 0; p < e.length; p++) {
		...
		switch (m) {
			...
			case Sr: {
				...
				let u = n.pop();
				r = u?.target ?? i, s = u?.currentList ?? null, t = u?.containsCombinator ?? !1;
				break;
			}
			case Rr:
			case Lt:
	...
	for (let [m, u] of p) {
		...
		}
		{
			...
			if (h !== -1) {
				...
				let y = d$2 === null || v.modifier?.kind === "arbitrary" ? null : `${u}/${d$2}`;
...
var rr = class {
	...
	getCompletions(i) {
		return this.has(i, "static") ? this.completions.get(i)?.() ?? [{
			supportsNegative: !1,
			values: [],
			modifiers: []
		}] : this.completions.get(i)?.() ?? [];
	}
	suggest(i, r) {
...
function si(e) {
			...
			return (A) => {
				...
				if (A.value) if (A.value.kind === "arbitrary") {
					...
					if (T === null && C && g.handleNegativeBareValue) {
						if (T = g.handleNegativeBareValue(A.value), !T?.includes("/") && A.modifier) return;
						if (T !== null) return g.handle(T, null);
					}
					if (T === null && g.handleBareValue && (T = g.handleBareValue(A.value), !T?.includes("/") && A.modifier)) return;
	...
	} }), t("bg-repeat", [["background-repeat", "repeat"]]), t("bg-no-repeat", [["background-repeat", "no-repeat"]]), t("bg-repeat-x", [["background-repeat", "repeat-x"]]), t("bg-repeat-y", [["background-repeat", "repeat-y"]]), t("bg-repeat-round", [["background-repeat", "round"]]), t("bg-repeat-space", [["background-repeat", "space"]]), t("bg-none", [["background-image", "none"]]);
	{
		let w = function(T) {
			...
			else T?.kind === "arbitrary" && (K = T.value);
			return K;
			...
			P(s, (l) => {
				...
				if (l.value === "--spacing" && !(t["--modifier"].usedSpacingNumber && t["--value"].usedSpacingNumber)) return P(l.nodes, (f) => {
					...
					for (let p of f.nodes) if (p.kind === "word") {
						if (p.value === "integer") t[c].usedSpacingInteger ||= !0;
						else if (p.value === "number" && (t[c].usedSpacingNumber ||= !0, t["--modifier"].usedSpacingNumber && t["--value"].usedSpacingNumber)) return V.Stop;
					}
				}), V.Continue;
...
`);
			...
			if (P([s], (h, k) => {
				let y = k.parent;
				if (y?.kind !== "rule" && y?.kind !== "at-rule" || h.kind !== "declaration" || !h.value) return;
				let S = !1, x = M(h.value);
				if (P(x, (b) => {
					if (b.kind === "function") {
						if (b.value === "--value") {
...
function nt(e, i = null, r = !0) {
	...
	return P(e, { exit(n, s) {
		if (n.kind === "word" && n.value !== "0") {
			...
			if (d === "*" && (c?.[0] === 0 && c?.[1] === null || p?.[0] === 0 && p?.[1] === null)) return t = !0, V.ReplaceSkip(ne("0"));
			if (d === "*" && c?.[0] === 0 && c?.[1] !== null && p?.[1] === null) return t = !0, s.parent?.kind === "function" ? V.ReplaceSkip(ne(`0${c[1]}`)) : V.ReplaceSkip(ne("0"));
			if (d === "*" && p?.[0] === 0 && p?.[1] !== null && c?.[1] === null) return t = !0, s.parent?.kind === "function" ? V.ReplaceSkip(ne(`0${p[1]}`)) : V.ReplaceSkip(ne("0"));
			if (d === "*") {
				if (c?.[0] === 1 && c?.[1] === null) return t = !0, V.ReplaceSkip(f);
				if (p?.[0] === 1 && p?.[1] === null) return t = !0, V.ReplaceSkip(l);
			}
			if (d === "*" || d === "+") {
...
function xi(e, i) {
	if (i & 2) {
		if (e.property in ki) {
			let r = d(e.value, " ");
			return ki[e.property][r.length]?.map(([t, n]) => a(t, r[n], e.important));
		}
		if (e.property in bi) return bi[e.property]?.map((r) => a(r, e.value, e.important));
	}
	if (e.property in wi) {
		let r = d(e.value, " ");
		return wi[e.property][r.length]?.map(([t, n]) => a(t, r[n], e.important));
	}
	return null;
}
function pe(e, i) {
...
function jl(e, i, r) {
	let t = null;
	if (i.kind === "functional" && i.value?.kind === "arbitrary" && i.value.value.includes("var(--") ? t = i.value.value : i.kind === "arbitrary" && i.value.includes("var(--") && (t = i.value), t === null) return !0;
...
function Zl(e) {
	let i = Tt(e);
	for (let [r] of i) if (r.kind === "functional" && r.root === "data" && r.value?.kind === "arbitrary" && !r.value.value.includes("=")) r.value = {
		kind: "named",
		value: r.value.value
	};
	...
	} else r.kind === "functional" && r.root === "supports" && r.value?.kind === "arbitrary" && /^[a-z-][a-z0-9-]*$/i.test(r.value.value) && (r.value = {
		kind: "named",
		value: r.value.value
	});
	return e;
}
function* Ii(e, i = e.value?.value ?? "", r = /* @__PURE__ */ new Set()) {
	if (r.has(i)) return;
	if (r.add(i), yield {
		kind: "named",
		value: i,
			...
			return Ve(r, e), P(r, (n) => {
				if (n.kind === "at-rule" && n.params.includes(" ")) n.params = n.params.replaceAll(" ", "");
					...
					P(s, (d) => {
						...
						} else d.kind === "function" && d.value[0] === ":" && d.nodes[0]?.kind === "selector" && d.nodes[0]?.value[0] === ":" && (l = !0, d.nodes.unshift({
							kind: "selector",
							value: "*"
						}));
					}), l && (n.selector = oe(s, !0));
...
function Fi(e, i) {
	...
	function f(m) {
		...
		for (let v of m) {
			...
			i && P(k, (y) => (y.src ??= i, V.Continue)), k = Ne(k, p, 0), u.push(h ? k : []);
		}
		return u;
	}
	function c(m) {
	...
	for (let m of f) "nodes" in m && P(m.nodes, (u) => {
		...
		}
		{
			let I = $e(Object.keys(h), i, {
				...
				let j = I.nodeSorting.get(E)?.candidate, q = j ? h[j] : void 0;
	...
	return function(n, s) {
		...
		let f = (() => {
			...
			if (u !== null && typeof u == "object" && !Array.isArray(u)) {
				...
				for (let h in p) h !== "__CSS_VALUES__" && (u?.__CSS_VALUES__?.[h] & 4 && qi(v, h.split("-")) !== void 0 || (v[a$1(h)] = p[h]));
				return v;
			}
...
function mr({ designSystem: e, ast: i, resolvedConfig: r, featuresRef: t, referenceMode: n, src: s }) {
	let l = {
		...
		matchVariant(d, f, c) {
			function p(u, v, h) {
				return Ji(f(u, { modifier: v?.value ?? null }), h);
			}
			try {
			...
			e.variants.group(() => {
				...
				let h = u.value ? u.value.value : "DEFAULT", k = v.value ? v.value.value : "DEFAULT", y = (c?.values && Object.hasOwn(c.values, h) ? c.values[h] : void 0) ?? h, S = (c?.values && Object.hasOwn(c.values, k) ? c.values[k] : void 0) ?? k;
				if (c && typeof c.sort == "function") return c.sort({
					value: y,
					modifier: u.modifier?.value ?? null
				}, {
					value: S,
		...
		matchUtilities(d, f) {
			...
			for (let [m, u] of Object.entries(d)) {
				let v = function({ negative: h }) {
					return (k) => {
						if (k.value?.kind === "arbitrary" && c.length > 0 && !c.includes("any") && (k.value.dataType && !c.includes(k.value.dataType) || !k.value.dataType && !ge$1(k.value.value, c))) return;
						let y = c.includes("color"), S = null, x = !1;
						{
							...
							y && (D = Object.assign({
								...
								transparent: "transparent",
								current: "currentcolor"
							}, D)), k.value ? k.value.kind === "arbitrary" ? S = k.value.value : k.value.fraction && Object.hasOwn(D, k.value.fraction) ? (S = D[k.value.fraction], x = !0) : Object.hasOwn(D, k.value.value) ? S = D[k.value.value] : D.__BARE_VALUE__ && (S = D.__BARE_VALUE__(k.value) ?? null, x = (k.value.fraction !== null && S?.includes("/")) ?? !1) : S = D.DEFAULT ?? null;
						}
						if (S === null) return;
						let b;
						{
						...
						if (k.modifier && b === null && !x) return k.value?.kind === "arbitrary" ? null : void 0;
				...
				f?.supportsNegativeValues && e.utilities.functional(`-${m}`, v({ negative: !0 }), { types: c }), e.utilities.functional(m, v({ negative: !1 }), { types: c }), e.utilities.suggest(m, () => {
...
function ba(e) {
	...
	for (let s of e.configs) {
		...
		for (let f in d) e.extend[f] ??= [], e.extend[f].push(d[f]);
	}
...
function an(e, i) {
	...
	if (Object.keys(r).length > 0) {
		...
		i.variants.functional("aria", (f, c) => {
			let p = c.value;
			return p && p.kind === "named" && p.value in r ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: r[p.value]
	...
	if (Object.keys(t).length > 0) {
		...
		i.variants.functional("supports", (f, c) => {
			let p = c.value;
			return p && p.kind === "named" && p.value in t ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: t[p.value]
	...
	if (Object.keys(n).length > 0) {
		...
		i.variants.functional("data", (f, c) => {
			let p = c.value;
			return p && p.kind === "named" && p.value in n ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: n[p.value]
...
function on({ designSystem: e, base: i, ast: r, sources: t, configs: n, pluginDetails: s }) {
	...
	if (!e.important && c.important === !0 && (e.important = !0), typeof c.important == "string") {
		...
		P(r, (y, S) => {
			...
			let x = et(S);
			return x.parent?.kind === "rule" && x.parent.selector === k ? V.Stop : V.ReplaceStop(H(k, [y]));
		});
	}
...
async function Ea(e, i = {}) {
	...
	return {
		...
		build(h) {
			if (d === 0) return e;
			if (!l) return m ??= Ne(t, r, i.polyfills), m;
			let k = v, y = !1;
			v = !1;
			let S = p.size;
			for (let b of h) if (!r.invalidCandidates.has(b)) if (b[0] === "-" && b[1] === "-") {
				...
				k ||= I, y ||= I;
			} else p.add(b), k ||= p.size !== S;
			if (!k) return m ??= Ne(t, r, i.polyfills), m;
...
//#endregion
export { ze as Features, Ht as Polyfills, jf as __unstable__loadDesignSystem, zf as compile, Ea as compileAst, Ra as default };
